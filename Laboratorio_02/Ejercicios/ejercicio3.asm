...
loop:   bge $s5, $a2, done # while i<FB_LENGHT/2
	...
	andi $t2, $s6,0x000000ff # t2 = color Azul de la imagen: 0x000000ff
	andi $t3, $s6,0x00ff0000 # t2 = color Rojo de la imagen: 0x00ff0000
	andi $t4, $s6,0xff00ff00 # t2 = color NA y Verde de la imagen: 0xff00ff00
