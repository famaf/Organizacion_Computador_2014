...
loop:   bge $s5, $a2, done # while i<FB_LENGHT
	...
	andi $t2, $s6,0x000000ff # t2 = color Azul de la imagen
	andi $t3, $s6,0x00ff0000 # t3 = color Rojo de la imagen
	andi $t4, $s6,0xff00ff00 # t4 = colores NA y Verde de la imagen

	sll $t2, $t2, 16 # intercambio mascara colores
	srl $t3, $t3, 16 # intercambio mascara colores 
	
	or $t2, $t2, $t3
	or $t2, $t2, $t4 # contiene el color restaurado
	
	sw $t2, ($t0) # store ith pixel
